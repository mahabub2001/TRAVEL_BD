...
public class DistrictActivity extends AppCompatActivity {
    ...
    private void activeKhulanDivissionDistrict() {
    ...
    private void activeRangpurDivissionDistrict() {
        recyclerView=findViewById(R.id.recyclerviewId);
        String []districtName;
    ...
    private void activeBarisalDivissionDistrict() {
        recyclerView=findViewById(R.id.recyclerviewId);
        String []districtName;
    ...
    private void activeMaymensinghDivissionDistrict() {
    ...
    private void activeSylhetDivissionDistrict() {
    ...
    private void activeRajshahiDivissionDistrict() {
    ...
    private void activeChittagongDivissionDistrict() {
    ...
    private void activeDhakaDivissionDistrict() {
